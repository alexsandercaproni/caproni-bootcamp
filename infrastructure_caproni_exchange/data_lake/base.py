...
# Criando uma classe bucket base com padrao de nome, criptografia e versionamento ativo
class BaseDataLakeBucket(s3.Bucket):
    ...
    def __init__(self, scope: core.Construct, deploy_env: Environment, layer: DataLakeLayer, **kwargs):
        ...
        self.obj_name = f's3-caproni-{self.deploy_env.value}-data-lake-{self.layer.value}'
    ...
    def set_default_lifecycle_rules(self):
        """
        - Deleta objetos de upload que nao foram finalizado, após 7 dias
        - Nao sobescreve arquivos e sim, cria novas versoes de arquivos. Com isso, jogamos para a INFREQUENT_ACCESS após 30 dias
        - Joga pra Glacier em 60 dias (camada ainda mais barata)
        - Exclui após 360 dias
        """
