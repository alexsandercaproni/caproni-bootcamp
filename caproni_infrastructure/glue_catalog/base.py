...
from caproni_infrastructure.data_lake.base import BaseDataLakeBucket
...
class BaseDataLakeGlueDatabase(glue.Database):
    ...
    def __init__(
        ...
        self.obj_name = f"glue-caproni-{self.deploy_env.value}-data-lake-{self.data_lake_bucket.layer.value}"
